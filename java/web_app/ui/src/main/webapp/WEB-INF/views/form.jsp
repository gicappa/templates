...
<%--<c:if test="${!ajaxRequest}">--%>
    ...
    <%--<head>--%>
        ...
        <%--&lt;%&ndash;<link href="<c:url value="/resources/form.css" />" rel="stylesheet"  type="text/css" />&ndash;%&gt;--%>
        <%--&lt;%&ndash;<script type="text/javascript" src="<c:url value="/resources/jquery/1.6/jquery.js" />"></script>&ndash;%&gt;--%>
    <%--</head>--%>
    <%--<body>--%>
<%--</c:if>--%>
<%--<div id="formsContent">--%>
